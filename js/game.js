...
let questions = [
  ...
  {
    question:
      "Which of the following is NOT a type of pop up box in JavaScript?",
    choice1: "Alert",
    choice2: "Confirm",
    choice3: "Prompt",
    choice4: "Amazon",
  ...
  },
  {
    ...
    choice2:
      "When a writer needs to increase the drama but couldn't let a main character expire",
    choice3:
      "They are placed to allow special characters to display when they normally wouldn't",
...
getNewQuestion = () => {
  if (availableQuestions.length === 0 || questionCounter > numQuestions) {
    // This keeps track of the number of questions left or if you somehow managed to go past the numQuestions variable. Probably through magic.
...
choices.forEach((choice) => {
  choice.addEventListener("click", (e) => {
    ...
    let classToApply =
      selectedAnswer == currentQuestion.answer ? "correct" : "incorrect"; //Sets a variable to each question to determine if the answer is correct or not.
